...
public class act26 {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		System.out.println(obtenerPuntos(matriu, vector, "SC_Huelva"));
	}
	...
	public static int obtenerPuntos(char[][] matriu, String[] vector, String equip) {
		int punt = 0;
		int posEquip = indice(vector, equip);
		for (int i = 0; i < matriu.length; i++) {
			if (matriu[i][posEquip] == '2') {
				punt += 3;
			}
			if (matriu[i][posEquip] == 'X') {
				punt++;
			}
		}
		return punt;
