...
public class TestFecha {
	...
	public void testDiasMes() {
		for (int mes : new int[] {1, 3, 5, 7, 8, 10, 12})
			assertEquals("El mes " + mes + " tiene 31 días", 31, Fecha.díaMes(mes, 1969));
		for (int mes : new int[] {4, 6, 9, 11})
			assertEquals("El mes " + mes + " tiene 30 días", 30, Fecha.díaMes(mes, 1969));
		for (int año : new int [] {1900, 1902, 1905, 2100, 2114})
			assertEquals("Febrero en  " + año + " tiene 28 días", 28, Fecha.díaMes(2, año));
		for (int año : new int [] {1904, 1912, 2000, 2016, 2104})
			assertEquals("Febrero en  " + año + " tiene 29 días", 29, Fecha.díaMes(2, año));
	}
	...
	private void testDíaSiguienteAño(int año) {
		for (int mes = 1 ; mes <= 12 ; mes++ ) {
			int ndías = Fecha.díaMes(mes, año);	
